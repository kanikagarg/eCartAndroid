...
public class AdminAddNewProductActivity extends AppCompatActivity {
    private String categoryName, pName, pDescription,pPrice,pQty, saveCurrentDate, saveCurrentTime, productRandomKey;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectImageBtn= findViewById(R.id.select_product_image);
    ...
    private void validateProductData() {
        ...
        if(imageUri == null){
            Toast.makeText(AdminAddNewProductActivity.this, "Please select Image",Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty(pName)){
            Toast.makeText(AdminAddNewProductActivity.this, "Please provide Product Name",Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty(pDescription)){
            Toast.makeText(AdminAddNewProductActivity.this, "Please provide Product Description",Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty(pPrice)){
            Toast.makeText(AdminAddNewProductActivity.this, "Please provide Product Price",Toast.LENGTH_SHORT).show();
        }else if (TextUtils.isEmpty(pQty)){
            Toast.makeText(AdminAddNewProductActivity.this, "Please provide Product Quantity",Toast.LENGTH_SHORT).show();
        }else{
            //store product's attributes to the firebase
            storeProductInformation();
        }
    }
    //function stores product's attributes to the firebase
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this,"got Product Image usri successfully...",Toast.LENGTH_SHORT);
                            saveProductInfToDatabase();
                        }
                    }
                });
            }
    ...
    private void saveProductInfToDatabase() {
